...
/*   Updated: 2022/01/04 17:27:07 by eyohn            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void) {
	...
	// // std::cout << "1" << std::endl;
	// std::allocator<ft::pair<const int, int> > aloc = f.get_allocator();						// get allocator test function
	// // std::cout << "2" << std::endl;
	// ft::pair<const int, int>* pointer = aloc.allocate(sizeof(ft::pair<const int, int>));		// use allocator pointer
	// // std::cout << "3" << std::endl;
	// ft::map<const int, int>* ff = new (pointer) ft::map<const int, int>;				// start constructor at the adress
	// // std::cout << "4" << std::endl;
	// std::allocator<ft::pair<const int, int> > pp = ff->get_allocator();						// get allocator from object
	// // std::cout << "5" << std::endl;
	// ff->~map();																			// start destructor
	// // std::cout << "6" << std::endl;
	// aloc.deallocate(pointer, sizeof(ft::pair<const int, int>));								// free memory
	// // std::cout << "7" << std::endl;
	...
	// ft::pair<const int, int> p1(0, 0);
	// std::cout << (*((f.insert(p1)).first)).first << std::endl;
	// ft::pair<const int, int> p2(-1, 1);
	// f.insert(p2);
	// ft::pair<const int, int> p3(-2, 2);
	// f.insert(p3);
	// ft::pair<const int, int> p4(-2, 2);
	// f.insert(p4);
	// ft::pair<const int, int> p5(-3, 3);
	// f.insert(p5);
	// ft::pair<const int, int> p6(-4, 4);
	// f.insert(p6);
	// ft::pair<const int, int> p7(-5, 5);
	// f.insert(p7);
